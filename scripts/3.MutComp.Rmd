...
# Indicator genes associated with Wildtype cell line
#     s.Wildtype s.Minimal index      stat p.value
...
# Seconday functional classifications
...
#P=0.9336. Wildtype does NOT have smaller proportion of signif genes involved in membrane transport.

carbon<-matrix(c(2,14,2,12),nrow=2,ncol=2)
fisher.test(x=carbon,y=NULL,alternative="less")
#P=0.6475. Wildtype does NOT have smaller proportion of signif genes involved in central carbon metabolism.

biosynthesis<-matrix(c(0,16,3,11),nrow=2,ncol=2)
fisher.test(x=biosynthesis,y=NULL,alternative="two.sided")
#P=0.08966. The proportion of signif genes involved in biosynthesis is marginally different between the strains.
