...
# Results: t = -0.3605, df = 3, p-value = 0.7425. Not different

# Minimal: dN/dS different from 1?
dnds.min.ttest <- t.test(dnds.min$dnds, mu = 1, alternative ="two.sided")
# Results: t = -3.3607, df = 3, p-value = 0.05496. Marginally less than 1.
...
# Test for equal variance : P = 0.589 --> homogeneous variance
...
# Results: t = -4.5473, df = 3, p-value = 0.01992. Yes, different from neutral (mean = 0.41)
