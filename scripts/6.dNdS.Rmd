...
png(filename="./../../../figures/2.extended.data/FigExt2.png",
...
# Show Plot
img <- readPNG("./../../../figures/2.extended.data/FigExt2.png")
...
png(filename="./../../../figures/3.supplementary/FigS7.png",
    width = 1200, height = 1200, res = 96*2)
...
# Show Plot
img <- readPNG("./../../../figures/3.supplementary/FigS7.png")
