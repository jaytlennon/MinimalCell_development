...
syn3B_N = freq_list(r"C:\Users\rmoge\Box Sync\Mycoplasma\Strains\3B_N_DNDS_freqs.csv")######
syn3B_S = freq_list(r"C:\Users\rmoge\Box Sync\Mycoplasma\Strains\3B_S_DNDS_freqs.csv")######
syn1_N = freq_list(r"C:\Users\rmoge\Box Sync\Mycoplasma\Strains\1.0_N_DNDS_freqs.csv")######
syn1_S = freq_list(r"C:\Users\rmoge\Box Sync\Mycoplasma\Strains\1.0_S_DNDS_freqs.csv")######
...
mm9 = (1081335,287360,NDICT_3B["9"],(1+SDICT_3B["9"]))#adding a pseudocount of 1 to all samples because some of them have 0 fixed synonymous changes
mm10 = (1081335,287360,NDICT_3B["10"],(1+SDICT_3B["10"]))
mm11 = (1081335,287360,NDICT_3B["11"],(1+SDICT_3B["11"]))
mm13 = (1081335,287360,NDICT_3B["13"],(1+SDICT_3B["13"]))
...
mm1=(2079386,544861,NDICT_1["1"],(1+SDICT_1["1"]))
mm3=(2079386,544861,NDICT_1["3"],(1+SDICT_1["3"]))
mm4=(2079386,544861,NDICT_1["4"],(1+SDICT_1["4"]))
mm6=(2079386,544861,NDICT_1["6"],(1+SDICT_1["6"]))
...
neN=2079386-1081335;neS=544861-287360
mm1e=(1081335,287360,8,3)
mm3e=(1081335,287360,12,3)
mm4e=(1081335,287360,8,3)
mm6e=(1081335,287360,8,1)
