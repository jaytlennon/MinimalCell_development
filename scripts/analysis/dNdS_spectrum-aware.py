...
#%%
Nmin=calc_targetsize(p=0.013435701,q=0.015355086,r=0.038387716,s=0.009596929,t=0.654510557,possATtoCG=303273,possATtoGC=204218,posstATtoTA=265192,possCGtoGC=113261,possCGtoTA=96506,possGCtoTA=98885)
Smin=calc_targetsize(p=0.013435701,q=0.015355086,r=0.038387716,s=0.009596929,t=0.654510557,possATtoCG=52292,possATtoGC=157137,posstATtoTA=61057,possCGtoGC=2053,possCGtoTA=11721,possGCtoTA=3100)
Nnonmin=calc_targetsize(p=0.011049724,q=0.072375691,r=0.037569061,s=0.10441989,t=0.419337017,possATtoCG=585378,possATtoGC=397994,posstATtoTA=513439,possCGtoGC=215178,possCGtoTA=180519,possGCtoTA=186790)
Snonmin=calc_targetsize(p=0.011049724,q=0.072375691,r=0.037569061,s=0.10441989,t=0.419337017,possATtoCG=98053,possATtoGC=296696,posstATtoTA=113194,possCGtoGC=4631,possCGtoTA=25669,possGCtoTA=6581)

essN=calc_targetsize(p=0.011049724,q=0.072375691,r=0.037569061,s=0.10441989,t=0.419337017,possATtoCG=303273,possATtoGC=204218,posstATtoTA=265192,possCGtoGC=113261,possCGtoTA=96506,possGCtoTA=98885)
essS=calc_targetsize(p=0.011049724,q=0.072375691,r=0.037569061,s=0.10441989,t=0.419337017,possATtoCG=52292,possATtoGC=157137,posstATtoTA=61057,possCGtoGC=2053,possCGtoTA=11721,possGCtoTA=3100)
neN=calc_targetsize(p=0.011049724,q=0.072375691,r=0.037569061,s=0.10441989,t=0.419337017,possATtoCG=585378-303273,possATtoGC=397994-204218,posstATtoTA=513439-265192,possCGtoGC=215178-113261,possCGtoTA=180519-96506,possGCtoTA=186790-98885)
neS=calc_targetsize(p=0.011049724,q=0.072375691,r=0.037569061,s=0.10441989,t=0.419337017,possATtoCG=98053-52292,possATtoGC=296696-157137,posstATtoTA=113194-61057,possCGtoGC=4631-2053,possCGtoTA=25669-11721,possGCtoTA=6581-3100)
