...
=======
>>>>>>> 7722b326854bd74c40a493cbb80654c47a69da22
```
...
#########################################################################################################################
#########################################################################################################################
#Part 4: Address questions of R3
x7s1e<-6;n7s1tot<-14
x7s1emax<-493;n7s1totmax<-901
twoprop_essentialins1<-prop.test(x=c(x7s1e,x7s1emax),n=c(14,901),alternative = 'two.sided')
#p=0.5393. No bias.

R3_mutn_numbers<-read.csv("~/GitHub/MinimalCell/datafiles/R3_mutation.numbers.csv")
is_there_bias<-t.test(x=R3_mutn_numbers$essential,y=R3_mutn_numbers$nonessential.corrected,alternative='two.sided',mu=0,paired=TRUE)
is_there_bias
```