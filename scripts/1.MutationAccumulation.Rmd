...
# Add legend
legend(1.2, 1.0, c("Non-minimal", "Minimal"), pch = 22, 
...
# Add x-axis labels
text(2, -0.075, "A:T \u2192 C:G", cex= 1, srt = 0, xpd = NA)
text(5, -0.075, "A:T \u2192 G:C", cex= 1, srt = 0, xpd = NA)
text(8, -0.075, "A:T \u2192 T:A", cex= 1, srt = 0, xpd = NA)
text(11, -0.075, "C:G \u2192 G:C", cex= 1, srt = 0, xpd = NA)
text(14, -0.075, "C:G \u2192 T:A", cex= 1, srt = 0, xpd = NA)
text(17, -0.075, "C:G \u2192 A:T", cex= 1, srt = 0, xpd = NA)
...
# Add legend
legend(1.5, 1.0, c("Non-minimal", "Minimal"), pch = 22, 
       pt.bg = c("blue", "red"), pt.cex = 2, pt.lwd = 1.5, 
       bty = 'n', y.intersp = 1)
...
text(2, 0.25, expression("."), cex= 1.2)
text(5, 0.25, expression("***"), cex= 1.5)
text(8, 0.25, expression("."), cex= 1.2)
...
##############################################################
#Is the avg length of a deletion longer in the Non-minimal than in the minimal? Here again including the deletions >100 bp
...
#2.0e09 vs 1.1e09 mutations tested during the course of the evolution, assuming an avg cell dens of 1e07 cells/mL. So either way, a mutation at every position has been tested 2.0e09/1e06 = 2000 (Non-minimal) versus 1.1e09/5e05=2200 (minimal) times during the NSE.
