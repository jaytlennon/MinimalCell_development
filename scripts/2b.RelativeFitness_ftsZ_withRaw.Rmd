...
```{r}
# Make figure
png(filename="~/GitHub/MinimalCell/figures/FigS2_withRaw.png",
...
points(jitter(rep(1, length(filter(rel.fit.raw,strain=="JCVI-syn1.0" & Mutation=="None")$W_1.0)), amount = 0.35), 
...
points(jitter(rep(3, length(filter(rel.fit.raw,strain=="JCVI-syn3B" & Mutation=="ftsZ")$W_1.0)), amount = 0.25), 
...
points(jitter(rep(3, length(filter(rel.fit.raw,strain=="JCVI-syn1.0" & Mutation=="ftsZ")$W_1.0)), amount = 0.25), 
...
# Show Plot
img <- readPNG("~/GitHub/MinimalCell/figures/FigS2_withRaw.png")
