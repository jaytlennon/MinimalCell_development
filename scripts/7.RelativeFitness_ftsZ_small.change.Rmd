...
# Results: t = 21.918, df = 15, p-value =  8.337e-13
# Minimization led to 78% or 4.5-fold reduction in fitness
...
# Test for equal variance: P = 3.856e-11 -> heterogeneous variance

t.test(c(filter(rel.fit.raw, strain == "JCVI-syn1.0", Mutation=="ftsZ")$W_1.0),
       c(filter(rel.fit.raw, strain == "JCVI-syn3B",Mutation=="ftsZ")$W_1.0),
       paired = F,alternative = "two.sided", mu = 0, var.equal = F)
# Results: t = 3.3915, df = 8.0459, p-value = 0.0094
# ftsZ mutant on non-min is 105% or 3.65-fold larger than ftsZ mutant on min
...
# Results: t = 1.0643, df = 12, p-value = 0.1541
# ftsZ mutation increased non-minimal fitness by 45% or 1.45-fold
...
t.test(c(filter(rel.fit.raw, strain == "JCVI-syn3B", Mutation == "ftsZ")$W_1.0),
       c(filter(rel.fit.raw, strain == "JCVI-syn3B", Mutation == "None")$W_1.0),
       paired = F,alternative = "greater", mu = 0, var.equal = T)
# Results:t = 7.5964, df = 22, p-value = 6.895e-08
# ftsZ mutation increased minimal fitness by 18% or 1.8-fold
```
