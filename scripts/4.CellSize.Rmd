...
```{r}
# Load data
size.raw <-read_csv("data2/cases_microbeJ.csv")
...
# Add P-values
mtext(expression("Timepoint x Strain:"), line = -2.5, cex = 0.7, at = 0.9)
mtext(expression(~italic("P")~"< 0.0001"), line = -3.5, cex = 0.60, at = 0.9)
